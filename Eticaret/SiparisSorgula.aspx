<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SiparisSorgula.aspx.cs" Inherits="Eticaret.SiparisSorgula" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main_content" runat="server">
    <div id="message" runat="server"></div>
    <div class="alert alert-default"><b>Sipariş Sorgulama Ekranı</b></div>
    E-Posta Adresiniz<br />
    <asp:TextBox ID="email" runat="server" CssClass="form form-control"></asp:TextBox><br />
    Sipariş Onay Kodunuz<br />
    <asp:TextBox TextMode="Number" ID="kod" runat="server" CssClass="form form-control"></asp:TextBox>
    <br />
    <asp:Button ID="btnSorgula" runat="server" CssClass="btn btn-primary" Text="Siparişi Sorgula" OnClick="btnSorgula_Click" />
    <br /><br /><br />
    <div id="panel" runat="server">
        <asp:HiddenField ID="lblUser" runat="server" />
        <asp:HiddenField ID="SiparisNo" runat="server" />
        <div class="alert alert-success"><b><i class="fa fa-info-circle"></i> Sipariş Durumu : </b> <asp:Label ID="durumu_goster" runat="server"></asp:Label></div>
